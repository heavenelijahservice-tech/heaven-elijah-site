  ...
  return (
    <section className="section-padding">
      <div className="container-hes">
        ...
        <div className="mt-10 grid gap-3 md:grid-cols-3 md:grid-rows-3">
          <BentoCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-3 max-w-xs text-sm text-text-muted">
                Mémoires, thèses et analyses livrés à des étudiants et chercheurs ouest-africains depuis 2021.
              </p>
            </div>
          </BentoCard>
          ...
          <BentoCard>
            ...
            <p className="mt-2 font-mono text-sm leading-relaxed">
              R · Python<br />Epi Info · Google Forms<br />Vancouver
            </p>
          </BentoCard>
        </div>
      </div>
